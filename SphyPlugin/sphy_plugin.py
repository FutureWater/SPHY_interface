...
/***************************************************************************
 ...
 Interface for the SPHY model
        ...
        begin                : 2014-09-09
        git sha              : $Format:%H$
        copyright            : (C) 2014 by FutureWater
        email                : info@futurewater.nl
 ***************************************************************************/
...
class SphyPlugin:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&SPHY model')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'SphyPlugin')
        self.toolbar.setObjectName(u'SphyPlugin')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('SphyPlugin', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/SphyPlugin/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'SPHY Model'),
            callback=self.run,
